...
I chose to look at Boston neighborhoods and voting precincts (both polygon data) as well as hospitals and community centers in the city (both point data).
...
## Transforming to the Massachusetts Mainland projection 
```{r}
MA_mainland <- "+proj=lcc +lat_1=42.68333333333333 +lat_2=41.71666666666667 +lat_0=41 +lon_0=-71.5 +x_0=200000.0001016002 +y_0=750000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=us-ft +no_defs"
...
There are only two community centers within 1000 meters of a hospital, which represents only 6% of community centers in the city. 
